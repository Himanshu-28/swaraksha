...
export default function FinalizeConsultation() {
    ...
    const prescription = location.state?.prescription as Prescription | undefined;
...
/** Persist the SOAP note (+ optional prescription) to localStorage so the patient can see it.
